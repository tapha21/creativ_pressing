...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Creativ Pressing — CRM pour pressings au Sénégal" },
      { property: "og:description", content: "Gérez clients, commandes, dépenses et performance depuis une seule plateforme pensée pour les pressings sénégalais." },
